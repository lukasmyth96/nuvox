...
valid_keyboard = [Key(x1=0 / 8, y1=0 / 8, w=7 / 8, h=1 / 8, key_id='display', contents=[], widget_type='text'),
...
invalid_keyboard_1 = [Key(x1=0 / 8, y1=0 / 8, w=7 / 8, h=1 / 8, key_id='display', contents=[], widget_type='text'),
                    Key(x1=6 / 8, y1=0 / 8, w=1 / 8, h=1 / 8, key_id='exit', contents=['X'])]

# overlaps in y direction
invalid_keyboard_2 = [Key(x1=0 / 8, y1=0 / 8, w=7 / 8, h=2 / 8, key_id='display', contents=[], widget_type='text'),
                      Key(x1=0 / 8, y1=1 / 8, w=1 / 8, h=1 / 8, key_id='exit', contents=['X'])]
