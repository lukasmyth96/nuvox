...
nuvox_new_keyboard = [Key(x1=0/5, y1=0/8, w=4/5, h=1/8, key_id='display', contents=[], widget_type='text'),
                      ...
                      Key(x1=0/5, y1=1/8, w=1/5, h=1/8, key_id='suggestion_1', contents=['']),
                      Key(x1=1/5, y1=1/8, w=1/5, h=1/8, key_id='suggestion_2', contents=['']),
                      Key(x1=2/5, y1=1/8, w=1/5, h=1/8, key_id='suggestion_3', contents=['']),
                      Key(x1=3/5, y1=1/8, w=1/5, h=1/8, key_id='suggestion_4', contents=['']),
                      Key(x1=4/5, y1=1/8, w=1/5, h=1/8, key_id='suggestion_arrow', contents=['→']),
